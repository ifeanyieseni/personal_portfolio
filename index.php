...
<head>
  <meta http-equiv="Refresh" content="0; URL=https://macvincent.com/">
  <meta charset="utf-8">
  <meta name="viewport" content="width=devce-width, initial-scale=1, shrink-to-fit=no">
  ...
  <link href="https://fonts.googleapis.com/css?family=Saira+Stencil+One|Source+Sans+Pro&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="css/min_style.css">
</head>
<body>
  <nav>
    <div class="name">       
        <h1 class="name">MacVincent</h1>
      </li>
    </div>
    <ul class="nav">
        <li class="nav-item">
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      <li class="sidebar-brand">
        <a class="js-scroll-trigger" href="#image"></a>
      </li>
